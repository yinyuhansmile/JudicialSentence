...
import shutil
import time
from nju.cnn_concat.network import Settings
from nju.cnn_concat.network import TextCNN
from nju.cnn_concat.judger import Judger
from nju.cnn_concat.data_helpers import train_batch_predict
import logging
import datetime

# sys.path.append('../..')
from nju.cnn_concat.data_helpers import to_categorical_accu
from nju.cnn_concat.data_helpers import to_categorical_law
...
data_train_path = '../data/jieba-data/data_train/batch/law/'
data_valid_path = '../data/jieba-data/data_valid/batch/law/'
