...
from nju.cnn_concat.data_helpers import eval_batch
from nju.cnn_concat.data_helpers import train_batch
...
# jieba 数据打包batch
def jieba_train_get_batch( batch_size=128):
...
def jieba_test_get_batch( batch_size=128):
...
# thulac 数据打包batch
def thulac_train_get_batch( batch_size=128):
...
def thulac_test_get_batch( batch_size=128):
